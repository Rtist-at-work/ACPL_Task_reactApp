...
const ProductCard = React.memo(
  ({ product, onEdit, setDeletingId, deletingId, setConfirmOpen }) => {
    // image uri
        ...
        <div className="mt-4 flex flex-col flex-grow">
          ...
          <div className="flex gap-3 mt-auto pt-4">
            ...
            <button
              ...
              disabled={isDeleting}
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-full text-sm font-medium transition bg-red-500 hover:bg-red-600 text-white`}
            >
